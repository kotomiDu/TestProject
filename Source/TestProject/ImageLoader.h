...
class TESTPROJECT_API UImageLoader : public UObject
{
	GENERATED_BODY()
public:
	/**
	...
	*/
	static TFuture<UTexture2D*> LoadImageFromDiskAsync(UObject* Outer, const FString& ImagePath, TUniqueFunction<void()> CompletionCallback);
...
private:
	...
	static UTexture2D* CreateTexture(UObject* Outer,  TArray<uint8>& PixelData, int32 InSizeX, int32 InSizeY, EPixelFormat PixelFormat = EPixelFormat::PF_B8G8R8A8, FName BaseName = NAME_None);
