...
TFuture<UTexture2D*> UImageLoader::LoadImageFromDiskAsync(UObject* Outer, const FString& ImagePath, TUniqueFunction<void()> CompletionCallback)
{
...
UTexture2D* UImageLoader::CreateTexture(UObject* Outer,  TArray<uint8>& PixelData, int32 InSizeX, int32 InSizeY, EPixelFormat InFormat, FName BaseName)
{
